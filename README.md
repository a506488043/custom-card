...
WordPress后台的"设置" > "网站卡片"页面提供了全新的管理界面：
...
1. 在WordPress后台的"设置" > "网站卡片"页面查看缓存状态
...
在WordPress后台的"设置" > "网站卡片"页面中点击"清理所有缓存"按钮，或者针对特定URL点击列表中的"删除"按钮。
...
是的，5.2.5版本修复了未登录用户无法显示卡片的问题。现在无论用户是否登录，都能正常查看网站卡片，并且访问数据会自动写入缓存系统。
